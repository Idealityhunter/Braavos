...
!function (a, b) {
  ...
  return function (a, b, c) {
    ...
    c.noop = function (a) {
      ...
      for (var c = 0; c < a.length; c++)if (a[c].length !== b)for (var d = a[c].length; b > d; d++)a[c][d] = void 0;
      return a
      ...
      function c(a) {
        if (a instanceof Array)for (var b = 0; b < a.length; b++)c(a[b]); else e && a > d.high && (d.high = a), f && a < d.low && (d.low = a)
      }

      var d = {
        high: void 0 === b.high ? -Number.MAX_VALUE : +b.high,
        low: void 0 === b.low ? Number.MAX_VALUE : +b.low
      }, e = void 0 === b.high, f = void 0 === b.low;
      ...
      var g, h, i, j = {high: b.high, low: b.low};
      ...
      var k = c.projectLength(a, j.step, j), l = d > k, m = f ? c.rho(j.range) : 0;
      if (f && c.projectLength(a, 1, j) >= d)j.step = 1; else if (f && m < j.step && c.projectLength(a, m, j) >= d)j.step = m; else for (; ;)if (l && c.projectLength(a, j.step, j) <= d)j.step *= 2; else {
      ...
      var j = h["axis" + a.units.pos.toUpperCase()], k = b.map(a.projectValue.bind(a)), l = b.map(j.labelInterpolationFnc);
    ...
    c.Interpolation = {}, c.Interpolation.none = function () {
      ...
      return function g(a, d) {
        ...
        for (var j, k = (new c.Svg.Path).move(a[0], a[1], !1, d[0]), l = 0, m = a.length; m - 2 * !j > l; l += 2) {
          var n = [{x: +a[l - 2], y: +a[l - 1]}, {x: +a[l], y: +a[l + 1]}, {x: +a[l + 2], y: +a[l + 3]}, {
            x: +a[l + 4],
            y: +a[l + 5]
          }];
    ...
    c.Axis = c.Class.extend({
      constructor: d, projectValue: function (a, b, c) {
    ...
    function d(a) {
      ...
      var e = c.createChartRect(this.svg, a, f.padding), g = c.getHighLow(d, a), h = new c.StepAxis(c.Axis.units.x, e, {
      ...
      }), j = this.svg.elem("g").addClass(a.classNames.labelGroup), k = this.svg.elem("g").addClass(a.classNames.gridGroup);
      c.createAxis(h, this.data.labels, e, k, j, this.supportsForeignObject, a, this.eventEmitter), c.createAxis(i, i.bounds.values, e, k, j, this.supportsForeignObject, a, this.eventEmitter), this.data.series.forEach(function (f, g) {
        ...
        }, m = "function" == typeof l.lineSmooth ? l.lineSmooth : l.lineSmooth ? c.Interpolation.cardinal() : c.Interpolation.none(), n = m(j, k);
        if (l.showPoint && n.pathElements.forEach(function (d) {
            var e = b[g].elem("line", {
              ...
              x2: d.x + .01,
              y2: d.y
            }, a.classNames.point).attr({value: d.data.value, meta: d.data.meta}, c.xmlNs.uri);
          ...
          var o = b[g].elem("path", {d: n.stringify()}, a.classNames.line, !0).attr({values: d[g]}, c.xmlNs.uri);
          this.eventEmitter.emit("draw", {
            type: "line",
            values: d[g],
            path: n.clone(),
        ...
        if (l.showArea) {
          var p = Math.max(Math.min(a.areaBase, i.bounds.max), i.bounds.min), q = e.y1 - i.projectValue(p).pos;
          n.splitByCommand("M").filter(function (a) {
            ...
            var i = b[g].elem("path", {d: h.stringify()}, a.classNames.area, !0).attr({values: d[g]}, c.xmlNs.uri);
            this.eventEmitter.emit("draw", {
              type: "area",
              values: d[g],
              path: h.clone(),
    ...
    "use strict";
    function d(a) {
      var b, d = [], e = c.getDataArray(this.data, a.reverseData), g = a.distributeSeries ? e.map(function (a) {
        return [a]
      ...
      j = a.distributeSeries && !a.stackBars ? g.length : a.distributeSeries && a.stackBars ? 1 : this.data.labels.length, a.horizontalBars ? (k = m = new c.StepAxis(c.Axis.units.y, n, {stepCount: j}), i = l = new c.LinearScaleAxis(c.Axis.units.x, n, {
        highLow: b,
        scaleMinSpace: a.axisX.scaleMinSpace,
        onlyInteger: a.axisX.onlyInteger,
        referenceValue: 0
      })) : (k = l = new c.StepAxis(c.Axis.units.x, n, {stepCount: j}), i = m = new c.LinearScaleAxis(c.Axis.units.y, n, {
        highLow: b,
        scaleMinSpace: a.axisY.scaleMinSpace,
        onlyInteger: a.axisY.onlyInteger,
        referenceValue: 0
      }));
      var o = this.svg.elem("g").addClass(a.classNames.labelGroup), p = this.svg.elem("g").addClass(a.classNames.gridGroup), q = a.horizontalBars ? n.x1 + i.projectValue(0).pos : n.y1 - i.projectValue(0).pos, r = [];
    ...
    function e(a) {
      ...
      for (var l = {x: b.x1 + b.width() / 2, y: b.y2 + b.height() / 2}, m = 1 === this.data.series.filter(function (a) {
        ...
        i[n] = this.svg.elem("g", null, null, !0), i[n].attr({"series-name": o.name}, c.xmlNs.uri), i[n].addClass([a.classNames.series, o.className || a.classNames.series + "-" + c.alphaNumerate(n)].join(" "));
        var p = j + k[n] / h * 360;
        p - j === 360 && (p -= .01);
        var q = c.polarToCartesian(l.x, l.y, e, j - (0 === n || m ? 0 : .2)), r = c.polarToCartesian(l.x, l.y, e, p), s = new c.Svg.Path(!a.donut).move(r.x, r.y).arc(e, e, 0, p - j > 180, 0, q.x, q.y);
        a.donut || s.line(l.x, l.y);
        var t = i[n].elem("path", {d: s.stringify()}, a.donut ? a.classNames.sliceDonut : a.classNames.slicePie);
        if (t.attr({value: k[n], meta: c.serialize(o.meta)}, c.xmlNs.uri), a.donut && t.attr({
          ...
          var u = c.polarToCartesian(l.x, l.y, f, j + (p - j) / 2), v = a.labelInterpolationFnc(this.data.labels ? this.data.labels[n] : k[n], n);
          if (v || 0 === v) {
            var w = i[n].elem("text", {
              dx: u.x,
              dy: u.y,
