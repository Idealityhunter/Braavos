      ...
      <div className="account-basic-wrap row">
        <form className="form-horizontal">
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">真实姓名</label>
          ...
          <div className="form-group avatar">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">照片</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">联系方式</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">Email</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">服务语言</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">店名</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">所在地</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
              <div className="form-control no-border">
              爪哇理想国
              </div>
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="inputEmail3" className="col-xs-4 col-sm-3 col-md-2 control-label">详细地址</label>
            <div className="col-xs-6 col-sm-7 col-md-8">
