...
ContactRequest = module.exports.ContactRequest = function(args) {
  ...
  if (args) {
    ...
    if (args.requestMessage !== undefined && args.requestMessage !== null) {
      this.requestMessage = args.requestMessage;
    }
    if (args.rejectMessage !== undefined && args.rejectMessage !== null) {
...
SecretKey = module.exports.SecretKey = function(args) {
  this.key = null;
  this.timestamp = null;
  this.expire = null;
  if (args) {
...
SecretKey.prototype = {};
SecretKey.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
SecretKey.prototype.write = function(output) {
  output.writeStructBegin('SecretKey');
...
UserInfo = module.exports.UserInfo = function(args) {
  ...
  if (args) {
    ...
    if (args.loginStatus !== undefined && args.loginStatus !== null) {
    ...
    if (args.loginSource !== undefined && args.loginSource !== null) {
      this.loginSource = Thrift.copyList(args.loginSource, [null]);
    }
    ...
    if (args.birth !== undefined && args.birth !== null) {
      this.birth = args.birth;
    }
    if (args.residence !== undefined && args.residence !== null) {
      this.residence = args.residence;
    }
    if (args.secretKey !== undefined && args.secretKey !== null) {
      this.secretKey = new ttypes.SecretKey(args.secretKey);
    }
  }
};
UserInfo.prototype = {};
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.BOOL) {
        this.loginStatus = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 120:
      if (ftype == Thrift.Type.STRING) {
        this.residence = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.STRUCT) {
        this.secretKey = new ttypes.SecretKey();
        this.secretKey.read(input);
      } else {
        input.skip(ftype);
      }
      break;
...
UserInfo.prototype.write = function(output) {
  ...
  if (this.loginStatus !== null && this.loginStatus !== undefined) {
    output.writeFieldBegin('loginStatus', Thrift.Type.BOOL, 8);
    output.writeBool(this.loginStatus);
    output.writeFieldEnd();
  }
  if (this.loginTime !== null && this.loginTime !== undefined) {
    output.writeFieldBegin('loginTime', Thrift.Type.I64, 9);
    output.writeI64(this.loginTime);
    output.writeFieldEnd();
  }
  if (this.logoutTime !== null && this.logoutTime !== undefined) {
    output.writeFieldBegin('logoutTime', Thrift.Type.I64, 10);
    output.writeI64(this.logoutTime);
    output.writeFieldEnd();
  }
  if (this.loginSource !== null && this.loginSource !== undefined) {
    output.writeFieldBegin('loginSource', Thrift.Type.LIST, 11);
    output.writeListBegin(Thrift.Type.STRING, this.loginSource.length);
    for (var iter14 in this.loginSource)
    {
      if (this.loginSource.hasOwnProperty(iter14))
      {
        iter14 = this.loginSource[iter14];
  ...
  if (this.email !== null && this.email !== undefined) {
    output.writeFieldBegin('email', Thrift.Type.STRING, 15);
    output.writeString(this.email);
    output.writeFieldEnd();
  }
  if (this.memo !== null && this.memo !== undefined) {
    output.writeFieldBegin('memo', Thrift.Type.STRING, 20);
    output.writeString(this.memo);
    output.writeFieldEnd();
  }
  if (this.roles !== null && this.roles !== undefined) {
    output.writeFieldBegin('roles', Thrift.Type.LIST, 100);
  ...
  if (this.birth !== null && this.birth !== undefined) {
    output.writeFieldBegin('birth', Thrift.Type.STRING, 110);
    output.writeString(this.birth);
    output.writeFieldEnd();
  }
  if (this.residence !== null && this.residence !== undefined) {
    output.writeFieldBegin('residence', Thrift.Type.STRING, 120);
    output.writeString(this.residence);
    output.writeFieldEnd();
  }
  if (this.secretKey !== null && this.secretKey !== undefined) {
    output.writeFieldBegin('secretKey', Thrift.Type.STRUCT, 200);
    this.secretKey.write(output);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
ChatGroup = module.exports.ChatGroup = function(args) {
  ...
  if (args) {
    ...
    if (args.groupDesc !== undefined && args.groupDesc !== null) {
    ...
    if (args.admin !== undefined && args.admin !== null) {
      this.admin = Thrift.copyList(args.admin, [null]);
    }
...
ChatGroup.prototype.write = function(output) {
  ...
  if (this.tags !== null && this.tags !== undefined) {
    ...
    for (var iter37 in this.tags)
    {
      if (this.tags.hasOwnProperty(iter37))
      {
        iter37 = this.tags[iter37];
  ...
  if (this.admin !== null && this.admin !== undefined) {
    ...
    for (var iter38 in this.admin)
    {
      if (this.admin.hasOwnProperty(iter38))
      {
        iter38 = this.admin[iter38];
  ...
  if (this.participants !== null && this.participants !== undefined) {
    ...
    for (var iter39 in this.participants)
    {
      if (this.participants.hasOwnProperty(iter39))
      {
        iter39 = this.participants[iter39];
...
ResourceConflictException = module.exports.ResourceConflictException = function(args) {
  Thrift.TException.call(this, "ResourceConflictException")
...
Thrift.inherits(ResourceConflictException, Thrift.TException);
ResourceConflictException.prototype.name = 'ResourceConflictException';
ResourceConflictException.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ResourceConflictException.prototype.write = function(output) {
  output.writeStructBegin('ResourceConflictException');
  if (this.message !== null && this.message !== undefined) {
    output.writeFieldBegin('message', Thrift.Type.STRING, 1);
    output.writeString(this.message);
    output.writeFieldEnd();
