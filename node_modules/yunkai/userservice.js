...
userservice_setContact_args = function(args) {
};
userservice_setContact_args.prototype = {};
userservice_setContact_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
userservice_setContact_args.prototype.write = function(output) {
  output.writeStructBegin('userservice_setContact_args');
  output.writeFieldStop();
  output.writeStructEnd();
  return;
};

userservice_setContact_result = function(args) {
};
userservice_setContact_result.prototype = {};
userservice_setContact_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
userservice_setContact_result.prototype.write = function(output) {
  output.writeStructBegin('userservice_setContact_result');
  output.writeFieldStop();
  output.writeStructEnd();
  return;
};
...
userserviceClient.prototype.setContact = function(callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
userserviceClient.prototype.send_setContact = function() {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('setContact', Thrift.MessageType.CALL, this.seqid());
  var args = new userservice_setContact_args();
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
};

userserviceClient.prototype.recv_setContact = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new userservice_setContact_result();
  result.read(input);
  input.readMessageEnd();
...
userserviceProcessor.prototype.process_setContact = function(seqid, input, output) {
  var args = new userservice_setContact_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.setContact.length === 0) {
    Q.fcall(this._handler.setContact)
      .then(function(result) {
        var result = new userservice_setContact_result({success: result});
        output.writeMessageBegin("setContact", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("setContact", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  } else {
    this._handler.setContact(function (err, result) {
      if (err == null) {
        var result = new userservice_setContact_result((err != null ? err : {success: result}));
        output.writeMessageBegin("setContact", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("setContact", Thrift.MessageType.EXCEPTION, seqid);
